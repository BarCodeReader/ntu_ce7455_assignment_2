...
from utils.model import TFDecoderRNN, EncoderTF
from utils.test_tf import evaluateRandomly, test
from utils.train_tf import trainIters
...
if __name__ == "__main__":
    ...
    encoder1 = EncoderTF(input_lang.n_words, opt.hidden_size, device).to(device)
    decoder1 = TFDecoderRNN(opt.hidden_size, output_lang.n_words, device).to(device)
